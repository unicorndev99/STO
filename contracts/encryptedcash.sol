...
contract EncryptedCash is ERC20Detailed, ERC20Pausable, MinterRole, BlacklistedRole {
  ...
  //   uint256 private _totalSupply = 10000000 * (10 ** uint256(decimals));
        ...
        public
    {
        ...
        _public_amount = 10 * 10**5 * 10**uint256(decimals);
        _utility_amount = 35 * 10**5 * 10**uint256(decimals);
        _future_amount = 5 * 10**5 * 10**uint256(decimals);
        _team_amount = 20 * 10**5 * 10**uint256(decimals);

        presale_address = ;
        liquidity_address = 0x30cB8e75e75107eBe1536E3168EfE3f80382b544;
        public_address = 0xf83309E3B61e42762968418AAaDE9b247A8c9214;
        utility_address = 0x0A074cAF4f2b69C3740067F4a36cde7F686EE725;
        future_address = 0x78D90f08fC1638c556f3254a9Ec8844B977AacD1;
        team_address = 0x69d2CB1DBEab54e93eF2fA83965F8FD5e7371EC3;
        ...
        transfer(future_address, _future_amount);
        transfer(team_address, _team_amount);
    ...
    function mint(address to, uint256 value) internal onlyNotBlacklisted onlyMinter returns (bool) {
        _mint(to, value);
        return true;
    }
