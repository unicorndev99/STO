...
const SideDrawer = ({mainLinks, presaleLink, moreMenuLinks, onClose, open, window, handleClickContracts}) => {  const router = useLocation();
      ...
      <Box sx={{ overflow: 'auto' }}>
        ...
        >
          ...
          <ListItemButton
            onClick={onClose}
            component="a"
            href={process.env.REACT_APP_CASH_WHITEPAPER_URL}
            target="_blank"
            rel="noopener noreferrer"
          >
            <ListItemText primary="CASH whitepaper" />
          </ListItemButton>
          <ListItemButton
