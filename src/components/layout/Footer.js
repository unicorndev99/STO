...
const socialLinks = [
  {
    label: 'Twitter',
    icon: <TwitterIcon />,
    href: 'https://twitter.com/cash_encrypted'
  },
  // {
  //   label: 'Telegram',
  //   icon: <TelegramIcon />,
  ...
  // },
  {
    label: 'Facebook',
    icon: <FacebookIcon />,
    href: 'https://www.facebook.com/groups/1684892028543460/'
  },
  {
    label: 'Discord',
    icon: <DiscordIcon />,
    href: 'https://discord.gg/RMSMmudXTb'
  }
]
    ...
    <Container sx={{mt: 5}}>
      ...
      >
        ...
        <Grid item xs={2} md={1} sx={{textAlign: 'center'}}>
          <IconButton 
            component="a"
            href="mailto:Brian.Mc@encrypted.cash"
            aria-label="Email"
          >
            <EmailIcon />
          </IconButton>
      ...
      >
        {'Copyright © '} {new Date().getFullYear()} CASH. All rights reserved. 
      </Typography>
    </Container>
  );
}
