...
const stage1 = [
  {text: "Whitepaper Creation", done: false},
  {text: "Fulfilling Legal Requirements", done: false}
]

const stage2 = [
  {text: "Token development", done: false}, 
  {text: "Smart contract development", done: false}, 
]

const stage3 = [
  {text: "Dashbard Setup", done: false}
]

const stage4 = [
  {text: "Initiate Public Sale", done: false}
]

const stage5 = [
  {text: "End of the sale & Token Issuance", done: false}
]
